...
/*
Since I'm doing this based on examples.  This is literally just an example problem that required an efficient bidirectional linked list.
It is represented with two arrays (next, prev)
This will be useful for future problems that require a O(1) removal operation and O(1) loookup.

This is a bidirectional linked list with an array of hashset for locations of interesting indicies in the linked list. 
*/
